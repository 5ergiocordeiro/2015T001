...
#define TYPE_FORMAT_STRING_SIZE   1701                              
#define PROC_FORMAT_STRING_SIZE   1777                              
#define EXPR_FORMAT_STRING_SIZE   1                                 
#define TRANSMIT_AS_TABLE_SIZE    0            
#define WIRE_MARSHAL_TABLE_SIZE   1            

typedef struct _OPC_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } OPC_MIDL_TYPE_FORMAT_STRING;

typedef struct _OPC_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } OPC_MIDL_PROC_FORMAT_STRING;

typedef struct _OPC_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } OPC_MIDL_EXPR_FORMAT_STRING;
...
extern const OPC_MIDL_TYPE_FORMAT_STRING OPC__MIDL_TypeFormatString;
extern const OPC_MIDL_PROC_FORMAT_STRING OPC__MIDL_ProcFormatString;
extern const OPC_MIDL_EXPR_FORMAT_STRING OPC__MIDL_ExprFormatString;
...
static const OPC_MIDL_PROC_FORMAT_STRING OPC__MIDL_ProcFormatString =
    {
        0,
        {
...
static const OPC_MIDL_TYPE_FORMAT_STRING OPC__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_OPC_0000_0000, ver. 0.0,
...
static const MIDL_STUBLESS_PROXY_INFO IOPCServer_ProxyInfo =
    {
    &Object_StubDesc,
    OPC__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    OPC__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _OPC_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _OPC_StubVtblList[] = 
{
...
PCInterfaceName const _OPC_InterfaceNamesList[] = 
{
    "IOPCServer",
...
#define _OPC_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _OPC, pIID, n)

int __stdcall _OPC_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _OPC, 9, 8 )
    IID_BS_LOOKUP_NEXT_TEST( _OPC, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _OPC, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _OPC, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _OPC, 9, *pIndex )
    
}

const ExtendedProxyFileInfo OPC_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _OPC_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _OPC_StubVtblList,
    (const PCInterfaceName * ) & _OPC_InterfaceNamesList,
    0, /* no delegation */
    & _OPC_IID_Lookup, 
    9,
    2,
